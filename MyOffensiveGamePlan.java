...
public class MyOffensiveGamePlan extends HttpServlet
   {
   private ConnectionPool pool;
   private ServletContext context;
   private static String servletName="MyOffensiveGamePlan";
   ...
   public void doGet(HttpServletRequest request,
      ...
      int snapOptions[]={0,1,2,3,4,5};
      String snapText[]={"Quick","On 1","On 2","On 3","On 4","Long"};
      ...
      Routines.WriteHTMLHead("My Offensive GamePlan",//title
                             false,//showMenu
                             2,//menuHighLight
                             false,//seasonsMenu
		                     false,//weeksMenu
      ...
      webPageOutput.println("<FORM ACTION=\"http://" +
                            ...
                            "/servlet/MyOffensiveGamePlan\" METHOD=\"POST\">");
      ...
      Routines.myTableColumnHeaders("<TD><FONT CLASS=\"opt2\">Sel</FONT></TD><TD><FONT CLASS=\"opt2\">Set</FONT></TD><TD><FONT CLASS=\"opt2\">Snap Count</FONT></TD><TD><FONT CLASS=\"opt2\">Play</FONT></TD>",webPageOutput);
      ...
      try
        ...
        queryResult1=sql1.executeQuery("SELECT PlayBookNumber,SnapCount,SetName,FormationName,PlayName,playbook.SetNumber,playbook.FormationNumber,playbook.PlayNumber " +
                                       "FROM playbook,defaultsets,defaultformations,defaultplays " +
                                       "WHERE playbook.Offense=1 " +
        ...
        while(queryResult1.next())
             ...
             snapCount=queryResult1.getInt(2);
             setName=queryResult1.getString(3);
             formationName=queryResult1.getString(4);
             playName=queryResult1.getString(5);
             setNumber=queryResult1.getInt(6);
             formationNumber=queryResult1.getInt(7);
             playNumber=queryResult1.getInt(8);
             ...
             if(selected&&"Change Play".equals(action))
               ...
               webPageOutput.println(snapText[snapCount]);
               Routines.tableDataEnd(false,false,false,webPageOutput);
      ...
      if("New Play".equals(action))
        ...
        if(!playBooksFound)
          ...
          webPageOutput.println("Snap Count");
          Routines.tableDataEnd(true,false,false,webPageOutput);
          Routines.tableDataStart(true,false,true,false,false,30,0,"scoresrow",webPageOutput);
   ...
   private synchronized boolean updateEntry(String action,
      ...
      if("Store New Play".equals(action))
        ...
        try
          ...
          {
		  Routines.writeToLog(servletName,"Unable to create playbook entry : ",false,context);	
          }
      ...
      if("Store Changed Play".equals(action))
        ...
        try
          ...
          {
		  Routines.writeToLog(servletName,"Unable to update playbook entry : ",false,context);	
          }
   ...
   private void formLine(boolean create,
      ...
      try
        ...
        Routines.tableDataEnd(false,false,false,webPageOutput);
        Routines.tableDataStart(true,false,false,false,false,15,0,"scoresrow",webPageOutput);
        webPageOutput.println("<SELECT NAME=\"snapCount\">");
        for(int currentOption=0;currentOption<snapOptions.length;currentOption++)
           {
           if((create&&snapOptions[currentOption]==3)||
              (!create&&snapOptions[currentOption]==snapCount))
             {
             selectText="SELECTED ";
             }
           else
             ...
             webPageOutput.println(" " +
                                   ...
                                   selectText +
                                   "VALUE=\"" +
                                   snapOptions[currentOption] +
                                   "\">" +
                                   snapText[currentOption]);
           }
        Routines.tableDataEnd(false,false,false,webPageOutput);
        Routines.tableDataStart(true,false,false,false,false,30,0,"scoresrow",webPageOutput);
        ...
        queryResult=sql.executeQuery("SELECT defaultformations.FormationNumber,FormationName,PlayNumber,PlayName " +
                                     ...
                                     "AND defaultformations.Offense=1 " +
